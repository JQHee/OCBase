...
- (void)setUpUI{
    self.backgroundColor = [UIColor colorWithRed:43.0/255 green:108.0/255 blue:108.0/255 alpha:0.85];
    ...
    self.height = tableView.height + kTriangleHeight * 2 - 1;
    self.alpha = 0;
